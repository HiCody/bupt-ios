...
//    self.customBottomToolBar.backgroundColor=[UIColor whiteColor];
//    self.customBottomToolBar.alpha=0.8;
    ...
    self.finishDoneBtn.backgroundColor=[UIColor colorWithRed:56/255.0 green:193/255.0 blue:255/255.0 alpha:1.0];
    self.finishDoneBtn.layer.cornerRadius=3.0;
    [self.finishDoneBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.finishDoneBtn.titleLabel.font = [UIFont systemFontOfSize:15.0];
      [self.finishDoneBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    CGFloat screenWidth = [UIScreen mainScreen].bounds.size.width;
    self.finishDoneBtn.frame = CGRectMake(screenWidth-10-60, 7,60, 30);
...
//    self.finishDoneBtn.frame = oldFrame;
    ...
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.customBottomToolBar.frame.size.width, 0.5)];
    view.backgroundColor=[UIColor lightGrayColor];
    [self.customBottomToolBar addSubview:view];
