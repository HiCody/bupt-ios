...
@interface HDetailsViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation HDetailsViewController
...
- (void)viewDidLoad {
    ...
    if (self.appIndex!=0) {
        ...
        self.interfaceString = DetailInterface;
    [self requestData];
}
...
//        applicationLable.textAlignment=NSTextAlignmentRight;
        ...
        startLabel.text =self.aModel.userName;
...
//            attachLable.textAlignment=NSTextAlignmentRight;
        ...
        CGSize nameSize =[self sizeWithText:self.aModel.userName font:[UIFont systemFontOfSize:16.0] maxSize:CGSizeMake(MAXFLOAT, MAXFLOAT)];
        
        UILabel *applicationLable = [[UILabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(titleLabel.frame)+8, nameSize.width, 30)];
        applicationLable.text = self.aModel.userName;
